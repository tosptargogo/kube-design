...
var _open = function open(args) {
  ...
  if (!(0, _lodash.includes)(PLACEMENT, options.placement)) {
  ...
  var newOptions = (0, _lodash.omit)(options, ["title", "content", "placement", "icon", "btns"]);
  ...
  var createNotice = function createNotice(notify) {
    notify.createNotice(_objectSpread({
      ...
      }, content)), btns ? /*#__PURE__*/_react["default"].createElement("div", {
