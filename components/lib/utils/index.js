...
function getScrollParents(node) {
  ...
  if (node == null) return [];
  if (node.nodeName === "HTML") return [].concat((0, _toConsumableArray2["default"])(parents), [window]);
  ...
  return getScrollParents(node.parentNode, isNodeScroll ? [].concat((0, _toConsumableArray2["default"])(parents), [node]) : (0, _toConsumableArray2["default"])(parents));
}
